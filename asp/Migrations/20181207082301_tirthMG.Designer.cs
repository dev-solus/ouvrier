...
namespace asp3.Migrations
{
    ...
    [Migration("20181207082301_tirthMG")]
    partial class tirthMG
    {
            ...
            modelBuilder.Entity("asp.Models.Article", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Description = "rasoire", IdCatalogue = 1, ImageUrl = "Catalogues/FB_IMG_1515691188716.jpg" },
                        ...
                        new { Id = 5, Description = "Exemeple de description", IdCatalogue = 7, ImageUrl = "Catalogues/zellige-carreaux.jpg" },
                        new { Id = 6, Description = "Exemeple de description", IdCatalogue = 7, ImageUrl = "Catalogues/1000_large.jpg" },
                        new { Id = 7, Description = "Exemeple de description", IdCatalogue = 7, ImageUrl = "Catalogues/zellige.jpg" },
                        new { Id = 8, Description = "hammam", IdCatalogue = 8, ImageUrl = "Catalogues/spa-sauna-hammam-douche.jpg" },
                        new { Id = 13, Description = "hammam", IdCatalogue = 8, ImageUrl = "Catalogues/auberge-de-l-orangerie.jpg" },
                        new { Id = 14, Description = "hammam", IdCatalogue = 8, ImageUrl = "Catalogues/spa-sauna-hammam-douche1.jpg" },
                        new { Id = 9, Description = "placar 1", IdCatalogue = 9, ImageUrl = "Catalogues/placar.jpg" },
                        new { Id = 10, Description = "placar 2", IdCatalogue = 9, ImageUrl = "Catalogues/placar2.jpg" },
                        new { Id = 11, Description = "placar 3", IdCatalogue = 9, ImageUrl = "Catalogues/placa3.png" }
                    );
                });
            ...
            modelBuilder.Entity("asp.Models.Catalogue", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, IdUser = 1, Nom = "Jardinage" },
